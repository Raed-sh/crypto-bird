...
const mainFetch = async () => {
    try {
      console.log(prov)
        ...
        // Get the netowrkID instance.
        const networkId = await web3.eth.net.getId();
        // get network props
        const deployedNetwork = GameContract.networks[networkId];
        // set contract in state as a smart contract and access it anywhere
...
const getLives = async () => {
  const x = await contract.methods.getAddress().call();
  console.log(x)
}
  ...
  return(
    <div className={isMob ? "home mob" : "home"}>
      ...
      <div className="buttons">
            ...
            <a onClick={() => getLives()}>Get New Lives <img src={heart}/></a>
      </div>

          <Wallet setIntraProvider={setProv} provider={prov}/>
